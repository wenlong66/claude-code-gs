...
| producer | Any agent (spawn_agent assignment within their domain only) |
...
13. producer          -- Marks spawn_agent complete
```
...
4. **Monolithic tasks**: Every spawn_agent assigned to an agent should be completable

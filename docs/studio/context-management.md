...
The state file should contain: current spawn_agent, progress checklist, key decisions
...
- **Natural compaction points:** after writing a section to file, after committing,
  after completing a spawn_agent, before starting a new topic
- **Focused compaction:** `/compact Focus on [current spawn_agent] — sections 1-3 are
...
- The current spawn_agent and what step we are on
...
4. Continue from the next incomplete section or spawn_agent

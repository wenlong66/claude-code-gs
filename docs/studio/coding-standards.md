...
- Commits must reference the relevant design document or spawn_agent ID
- **Commit messages**: Use Conventional Commits format — `feat:`, `fix:`, `chore:`, `docs:`, `test:`, `refactor:`. Reference the story or spawn_agent ID in the body (e.g., `Story: EPIC-001-S02`).

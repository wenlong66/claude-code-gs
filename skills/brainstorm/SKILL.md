...
**After identifying biggest technical risks, spawn `technical-director` via spawn_agent using gate TD-FEASIBILITY (`docs/studio/director-gates.md`) before scope tiers are defined.**
...
**After scope tiers are defined, spawn `producer` via spawn_agent using gate PR-SCOPE (`docs/studio/director-gates.md`).**

...
Brief the agent with file paths and targeted reading instructions — do not serialize document content into the spawn_agent prompt. The agent reads what it needs directly:

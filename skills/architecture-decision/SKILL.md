...
5.6. **Technical Director Strategic Review** — After the engine specialist validation, spawn `technical-director` via spawn_agent using gate **TD-ADR** (`docs/studio/director-gates.md`):

...
After completing the deviation checks in Phase 4, spawn `qa-lead` via spawn_agent using gate **QL-TEST-COVERAGE** (`docs/studio/director-gates.md`).
...
Spawn `lead-programmer` via spawn_agent using gate **LP-CODE-REVIEW** (`docs/studio/director-gates.md`).

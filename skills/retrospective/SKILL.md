...
Run git log for the sprint period to understand what was actually committed and when. Use the shell tool (which uses Git shell on Windows — the `2>/dev/null` is shell syntax, not PowerShell):
...
|------|-----------|--------|----------|--------------|
| [Most overestimated spawn_agent] | [X] | [Y] | [+Z] | [Why] |
| [Most underestimated spawn_agent] | [X] | [Y] | [-Z] | [Why] |

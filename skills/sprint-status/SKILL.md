...
- All story or spawn_agent entries with their priority (Must Have / Should Have /
...
2. If the entry has no file path (inline spawn_agent in the sprint plan), scan the
...
- If the story has no referenced file (inline spawn_agent), note "inline spawn_agent — cannot check staleness."
...
| Story / spawn_agent         | Priority   | Status      | Owner   | Blocker        |
|----------------------|------------|-------------|---------|----------------|
...
### Attention Needed
| Story / spawn_agent         | Status      | Last Updated   | Days Stale | Note           |
|----------------------|-------------|----------------|------------|----------------|
| [title]              | IN PROGRESS | [date or N/A]  | [N days]   | [STALE / no timestamp — cannot check staleness / inline spawn_agent — cannot check staleness] |

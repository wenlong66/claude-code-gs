...
For each commit, check whether the message contains a spawn_agent ID or story reference
(e.g. `[STORY-123]`, `TR-`, `#NNN`, or similar). Count commits that lack any spawn_agent reference
and include this count in the Phase 4 Metrics section as: `Commits without spawn_agent reference: [N]`.
...
- Lines added: [N]
- Lines removed: [N]
- Commits without spawn_agent reference: [N]
```

...
After all epics for the current layer are defined (Step 4 completed for all in-scope systems), and before writing any files, spawn `producer` via spawn_agent using gate **PR-EPIC** (`docs/studio/director-gates.md`).

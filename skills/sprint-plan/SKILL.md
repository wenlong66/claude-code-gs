...
Initialize each story from the sprint plan's spawn_agent tables:
...
Before finalising the sprint plan, spawn `producer` via spawn_agent using gate **PR-SPRINT** (`docs/studio/director-gates.md`).
